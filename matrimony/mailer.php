<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($event1) OR empty($event2) OR empty($guests) OR empty($guestinfo) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $recipient = "keegan@keeganjoyce.com";
        ...
        $email_content .= "Event1: $event1\n\n";
        $email_content .= "Event2: $event2\n\n";
