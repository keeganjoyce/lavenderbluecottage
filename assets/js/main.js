$(document).ready(function() {
    ...
    map.addMarker({
        ...
        lng: 144.974104,
        verticalAlign: 'top',
        title: 'Lavender Blue Cottage',  
        infoWindow: {
            content: '<div class="note">Ceremony</div><h4 class="map-title script">Lavender Blue Cottage</h4><div class="address"><span class="region">256 Main Creek Rd.</span><br><span class="postal-code">3928</span><br><span class="city-name">Main Ridge</span></div>'
        }
    ...
    map.addMarker({
        ...
        title: 'Parking',      
        infoWindow: {
            content: '<div class="note">Parking</div><h4 class="map-title script">Those who wish to drive</h4><div class="address"><span class="region">284 Main Creek Rd.</span><br><span class="postal-code">3928</span><br><span class="city-name">Main Ridge</span></div>'
        } 
    ...
    $('#cguests').on("change", function(){
        ...
        } else if ($(this).val() == 'No Guest' ) {
            $('.guestinfo-group').slideUp(); //hide
            console.log('No guests');
            $('#cguestinfo').val('No Guest'); //Pass data to the field so mailer.php can send the form.
    ...
    $(".rsvp-form").validate({
		messages: {
			...
			event1: {
				required: 'Are you attending the Wedding?' //You can customise this message
			},
            event2: {
                required: 'Are you attending breakfast the following day, 23rd December?' //You can customise this message
            },
			guests: {
				required: 'Will you bring a guest?' //You can customise this message
			},
			guestinfo: {
